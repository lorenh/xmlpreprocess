...
#region Copyright (C) 2002-2007 The Genghis Group
/*
 ...
 *
 * Portions Copyright (C) 2002-2007 The Genghis Group (http://www.genghisgroup.com/).
 *
...
namespace Genghis
{
    public class CommandLineParser
    {
        ...
        public abstract class UsageAttribute : Attribute
        {
            ...
            public bool EmptyValueAllowed = false;
                ...
                if (member.usage.ExpectsValue)
                {
                    ...
                    if (arg[0] == '/')
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (!member.usage.EmptyValueAllowed)
